...
if __name__ == '__main__':
    ...
    # paths
    parser.add_argument("--image_path", type=str, default="./results/test_images/help/grid_008.png", help="path to test dataset")
    parser.add_argument("--checkpoint_path", type=str, default='./checkpoints/few_shot/4/epoch_15.pth', help='path to checkpoint')
    # model
