...
if __name__ == '__main__':
    ...
    # paths
    parser.add_argument("--data_path", type=str, default="./data/mvtecdataset", help="path to test dataset") # ./data/dataset_masterproject
    parser.add_argument("--save_path", type=str, default='./results/few_shot/4/mvtec/', help='path to save results')
    parser.add_argument("--checkpoint_path", type=str, default='./checkpoints/few_shot/4/epoch_27.pth', help='path to checkpoint')
    parser.add_argument("--clip_model_path", type=str, default='./clip_model', help='path to clip model')
    # model
    parser.add_argument("--dataset", type=str, default='mvtec', help='name of dataset') # masterproject
