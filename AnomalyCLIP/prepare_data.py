...
parser.add_argument('--data-folder',default='./data/visadataset/', type=str,help='the path to downloaded VisA dataset')
parser.add_argument('--save-folder',default='./data/visadataset_1cls/', type=str,help='the target path to save the reorganized VisA dataset facilitating data loading in pytorch')
parser.add_argument('--split-file',default='./data/visadataset/split_csv/1cls.csv', type=str,help='the csv file to split downloaded VisA dataset')
...
if split_type == '1cls':
    for data in data_list:
        ...
        test_img_bad_folder = os.path.join(test_folder, 'anomaly')
        test_mask_bad_folder = os.path.join(mask_folder, 'anomaly')
