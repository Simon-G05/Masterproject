...
def generate_class_info(dataset_name):
    ...
    if dataset_name == 'mvtec':
        ...
        obj_list = ['cable', 'grid', 'metal_nut', 'screw', 'wood']
    elif dataset_name == 'masterproject':
        obj_list = ['bottle', 'cable', 'grid', 'metal_nut', 'screw', 'wood']
    elif dataset_name == 'anomalyclip':
        obj_list = ['btech_01', 'btech_02', 'btech_03', 'candle', 'capsules', 'cashew', 'chewinggum', 'fryum', 'macaroni1', 'macaroni2',
                    'mt_crack', 'pcb1', 'pcb2', 'pcb3', 'pcb4', 'pipe_fryum', 'tubes']
    elif dataset_name == 'anomalyclip_biggest':
        obj_list = ['bracket_black', 'bracket_brown', 'bracket_white', 'btech_01', 'btech_02', 'btech_03', 'candle', 'capsules', 'cashew', 'chewinggum', 'fryum', 
                    'macaroni1', 'macaroni2', 'mt_crack', 'pcb1', 'pcb2', 'pcb3', 'pcb4', 'pipe_fryum', 'tubes']
